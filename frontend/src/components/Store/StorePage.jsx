              ...
              {strategies.map(bot => {
                ...
                return (
                  <div key={bot.id} className="card">
                    ...
                    <div style={{ borderTop: '1px solid var(--border-primary)', paddingTop: 12, display: 'flex', gap: 8 }}>
                      <button
                        className="btn btn-sm btn-secondary"
                        style={{ flex: 1, borderColor: 'var(--border-primary)', color: 'var(--text-secondary)' }}
                        onClick={() => { setActiveStrategyDetails(bot); setShowStrategyDetailsModal(true); }}
                      >
                        <Info size={14} /> กลยุทธ์
                      </button>
                      <button 
                      ...
                      >
                        {isOwned ? (
                          ...
                          <><ShoppingCart size={14} /> หยิบใส่พอร์ต</>
                        )}
                      </button>
                    </div>
                  </div>
                  ...
                  return (
                    <div key={strat.id} className="card">
                      ...
                      <div style={{ borderTop: '1px solid var(--border-primary)', paddingTop: 12, display: 'flex', gap: 8 }}>
                        ...
                        {isSubscribed ? (
                          <button className="btn btn-sm btn-secondary" style={{ flex: 2, color: 'var(--loss)', borderColor: 'var(--loss)' }} onClick={() => handleUnsubscribe(strat.id)}>
                            ยกเลิกติดตาม
                          </button>
                        ) : (
                          <button className="btn btn-sm btn-primary" style={{ flex: 2 }} onClick={() => handleSubscribe(strat)}>
